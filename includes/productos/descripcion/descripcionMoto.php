    ...
    <main class="bg-dark">
        <div class="container">
            ...
            <div class="d-flex flex-wrap justify-content-start py-4 data-icons-tab border-top border-danger">
                ...
                <div class="d-inline-flex align-items-center data-icons-item">
                    <img src="../../../imagenes/muestra/transmision.png" alt="Transmisión" width="60" height="55" class="mr-lg-4 mr-2"> 
                    <h6 class="mb-0 pr-lg-4 text-white"><span class="fw-bold">Transmisión</span> <br class="d-none d-md-inline"><?php echo $moto['transmision']; ?></h6>
                </div>
                <div class="d-inline-flex align-items-center data-icons-item">
